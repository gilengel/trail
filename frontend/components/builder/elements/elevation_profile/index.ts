...
export const ElevationProfileElement: EditorElementDefinition<
  ElevationProfileProperties,
  ProvidedPropertiesRoute,
  ConsumedPropertiesRoute
> = createEditorElementDefinition({
  ...
  component: defineAsyncComponent(
    // @ts-ignore
    () => import("~/components/builder/elements/elevation_profile/Element.vue"),
  ),
