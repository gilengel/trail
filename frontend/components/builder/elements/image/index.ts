...
export const ImageElement: EditorElementDefinition<ImageProperties, [], []> =
  createEditorElementDefinition({
    ...
    component: defineAsyncComponent(
      // @ts-ignore
      () => import("~/components/builder/elements/image/Element.vue"),
    ),
    ...
    propertySchema: {
      scale: {
        ...
        component: defineAsyncComponent(
          // @ts-ignore
          () => import("~/components/builder/elements/image/types/Scale.vue"),
        ),
        label: "Scale",
        description: "",
      },
      aspectRatio: {
        ...
        component: defineAsyncComponent(
          () =>
            // @ts-ignore
            import("~/components/builder/elements/image/types/AspectRatio.vue"),
        ),
        label: "Aspect Ratio",
        defaultValue: "1",
      },
      sizeType: {
        ...
        component: defineAsyncComponent(
          // @ts-ignore
          () => import("~/components/builder/elements/image/types/Size.vue"),
        ),
        label: "Size",
        options: [
          ImageSize.Free,
          ImageSize.FitHorizontally,
          ImageSize.FitVertically,
        ],
        defaultValue: "0",
      },
    },
